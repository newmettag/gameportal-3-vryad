document.addEventListener("DOMContentLoaded", () => {
  ...
  // 6️⃣ ASCII-style хаотичный текст подзаголовка
...
// 9️⃣ Плавающие пиксельные эффекты
